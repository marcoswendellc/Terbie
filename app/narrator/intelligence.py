...
class GeminiNarrativeProvider(BaseNarrativeProvider):
    ...
    def _prompt(self, context: NarrativeContext) -> str:
        ...
        return (
            ...
            "única melhor campanha, responda diretamente com apenas a vencedora, "
            "identifique o shopping e use as demais métricas calculadas para enriquecer "
            ...
            "Não transforme um pedido singular em top 10. "
            ...
            "Em rankings, preserve rigorosamente a ordem de calculated_result e inclua "
            "todas as posições solicitadas. Você pode decidir entre lista, tabela ou "
            "texto conforme o pedido e a legibilidade, sem alterar nomes ou valores. "
            "Quando ele pedir uma tabela, entregue uma tabela Markdown no campo answer. "
            "Quando pedir uma "
