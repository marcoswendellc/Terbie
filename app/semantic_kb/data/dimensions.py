...
KB_DIMENSIONS: list[KBDimension] = [
    ...
    KBDimension(
        name="genero",
        column="genero",
        derived_from="cd_sexo",
        derivation_rule="F ou 0 = Feminino; M ou 1 = Masculino; O = Outros; nulo = Não informado.",
        synonyms=["genero", "sexo", "publico feminino", "publico masculino"],
    ),
    KBDimension(
        name="idade",
        column="idade",
        derived_from="dt_nascimento",
        derivation_rule="Idade completa na data da consulta.",
        synonyms=["idade", "idades"],
    ),
    KBDimension(
        name="faixa_etaria",
        column="faixa_etaria",
        derived_from="dt_nascimento",
        derivation_rule="0-17, 18-24, 25-34, 35-44, 45-59 e 60+.",
        synonyms=[
            "faixa etaria",
            "faixas etarias",
            "publico jovem",
